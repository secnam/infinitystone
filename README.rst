...
.. image:: https://travis-ci.org/TachyonicProject/tachyonic.svg?branch=master
    :target: https://travis-ci.org/TachyonicProject/tachyonic
    :alt: Build Status
...
* `Website <http://www.tachyonic.org/tachyonic>`__.
...
Luxon infrastructure and code is hosted on `GitHub <https://github.com/TachyonicProject/tachyonic>`_.
...
.. code:: bash
    ...
    $ git clone https://github.com/TachyonicProject/tachyonic.git
